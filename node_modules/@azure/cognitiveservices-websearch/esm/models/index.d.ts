 ...
 */
export declare type ResponseUnion = Response | SearchResponse | ThingUnion | AnswerUnion | ErrorResponse;
/**
 ...
 */
export declare type ThingUnion = Thing | CreativeWorkUnion | IntangibleUnion;
/**
 ...
 */
export declare type CreativeWorkUnion = CreativeWork | WebPage | MediaObjectUnion | ArticleUnion;
/**
 ...
 */
export declare type AnswerUnion = Answer | Computation | SearchResultsAnswerUnion;
/**
 ...
 */
export declare type SearchResultsAnswerUnion = SearchResultsAnswer | WebWebAnswer | Images | News | RelatedSearchesRelatedSearchAnswer | SpellSuggestions | TimeZone | Videos | Places;
/**
 ...
 */
export declare type IntangibleUnion = Intangible | StructuredValue;
/**
 ...
 * @enum {string}
 */
export declare type AnswerType = 'WebPages' | 'Images' | 'SpellSuggestions' | 'News' | 'RelatedSearches' | 'Videos' | 'Computation' | 'TimeZone';
/**
 ...
 */
export declare type WebSearchResponse = SearchResponse & {
    /**
